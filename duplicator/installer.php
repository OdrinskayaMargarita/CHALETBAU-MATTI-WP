...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211004_chaletbaumatti_5f1caebb3249ef4a3531_20211004125449_archive.zip';
    const ARCHIVE_SIZE       = '2347507';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '5f1caeb-04125449';
    const SECONDARY_PACKAGE_HASH = '4da65a3-04125449';
